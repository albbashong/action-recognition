...
class CLIP(nn.Module):
    ...
    def forward(self, image):
        ...
        logits_per_iamge = logit_scale * image_features
        #logits_per_text = logit_scale * text_features @ image_features.t()

        # shape = [global_batch_size, global_batch_size]
        #return logits_per_iamge, logits_per_text
        return logits_per_iamge
...
def build_model(state_dict: dict, skip_load=False):
    ...
    '''
    embed_dim=157    
    vision lyaers= [3, 4, 6, 3],
    vision_width=512 cause vision_width 
    vision_patch_size=16
    transformer_heads=8 in vivit
